...
contract Reward is Ownable, Pausable {
    ...
    // q - how this function will give steps covered in one month?
    ...
    // q - will use function if the token will be distributed by owner, instead of self claiming in Model1 and Model3.
